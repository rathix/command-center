...
├── go.mod                       # Go module (k8s.io/client-go)
├── go.sum
...
| `web/src/lib/components/` | Svelte UI components (ServiceList, StatusBar, etc.) | web |
